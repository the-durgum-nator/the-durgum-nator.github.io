...
When I first got in Louisiana State University, I mostly had a "general" idea of what I wanted out of college:
- Become a engineer who made software to help folk. 

<em>Pretty normal stuff, all things considered.</em><br>
And I did, but I never got a good chance to practice good and practical web-dev.

So, as ritual for most (if not all lol) software engineers, I decided to make a portfolio website!
<br>
~~Which you're on. Good job so far!~~
...
But I chose to tack on a JS framework just in case: <a href="https://astro.build/">Astro!</a><br>
Three reasons why:
...
But for now, it's definitely past a good minimal viable product.
Some things I like:
1. Styling's definitely a good one; I learned quite a lot of basic "what-not-to-do"s and "what-to-do"s <br>- ~~A lot more of the former than the latter.~~
2. I actually enjoy Astro!<br>-It's not as easy as it seems, but it's quite intuitive and most things have purpose to why they are.
3. Web dev is tough.<br>I see the influx on why web-developers find the need to "prove" themselves, cause it's  less "hackery" than what movies would lead you on to be.<br>But it's still code to write, and the required coding skills shift from math to designwork.


But a website is made, and idk how long I'll hold onto this.<br>
